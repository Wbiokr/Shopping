  ...
  <div class="mixin-components-container">
    ...
    <el-row :gutter="20" style="margin-top:50px;">
          ...
          <div style="height:100px;">
            <el-form :model="demo" :rules="demoRules">
              <el-form-item prop="title">
                <md-input v-model="demo.title" icon="search" name="title" placeholder="輸入標題">標題</md-input>
              </el-form-item>
            </el-form>
          </div>
        </el-card>
      ...
      <el-col :span="6">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>水波紋 waves v-directive</span>
          </div>
          <div class="component-item">
            <el-button v-waves type="primary">水波紋效果</el-button>
          </div>
        </el-card>
      </el-col>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      articleList: [
        { title: '基礎篇', href: 'https://juejin.im/post/59097cd7a22b9d0065fb61d2' },
        { title: '登錄權限篇', href: 'https://juejin.im/post/591aa14f570c35006961acac' },
        { title: '實戰篇', href: 'https://juejin.im/post/593121aa0ce4630057f70d35' },
        { title: 'vue-admin-template 篇', href: 'https://juejin.im/post/595b4d776fb9a06bbe7dba56' },
        { title: '優雅的使用 icon', href: 'https://juejin.im/post/59bb864b5188257e7a427c09' }
      ]
    }
  }
}
